...
import com.sample.UserProfileApplication;
...
@ContextConfiguration(classes = {DataSourceAutoConfiguration.class, HibernateJpaAutoConfiguration.class,UserProfileApplication.class})
@ActiveProfiles("test")
public class AccountIntegrationTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void findAll() throws Exception {
        ...
        mockMvc.perform(post("/userProfile/retrieveAll")
        ...
        MvcResult result = mockMvc.perform(get("/userProfile/retrieveAll")
                .accept(MediaType.APPLICATION_JSON))
    ...
    public void getAccountById() throws Exception {
        ...
        mockMvc.perform(post("/userProfile")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"alias\" : \"pepe\",\"userID\" : \"1\"}"))
                .andExpect(status().is2xxSuccessful());


        mockMvc.perform(get("/userProfile/{userID}", "1")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
